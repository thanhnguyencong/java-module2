package TDDD.SimpleCalculator;

import TDDD.SimpleCalculator.SimpleCalculator;
...
public class SimpleCalculatorTest {
    ...
    public void testAdd0And0() {
        ...
        int result = TDDD.SimpleCalculator.SimpleCalculator.add(first, second);
    ...
    public void testSub0and0() {
        ...
        int result = TDDD.SimpleCalculator.SimpleCalculator.sub(first, second);
        assertEquals(expected, result);
    }
